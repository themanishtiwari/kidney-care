...
<div class="container">
        ...
        <div class="col-md-2"></div>
            <div class="col-md-8  my-30">
                <form style="height: auto; border:2px solid black; border-radius: 15px !important; background-color: azure; " id="contact_form"
                        ...
                        <div class="col-sm-6">
                            <div class="form-group" id="disease">
                                ...
                                <select id="form_subject" name="disease" class="form-control" type="text">
                                    ...
                                    <option value="Kidney" selected>Kidney Problem</option>
