                ...
                <div class="row spacer">
                    <div class="col-md-6 ">
                        <form style="height: auto; border-radius: 15px !important;" id="contact_form"
                            ...
                            onsubmit="return validateForm()" action="patient-submit.php" enctype="multipart/form-data">
                            <h2 style="text-align: left;">Patient<span class="highlight"> Form</span></h2>
                            <p>Register for Patient Listing</p>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group" id="address">
                                        ...
                                        <input id="form_name" name="address" class="form-control" type="text"
                                            placeholder="Enter Patient Address" required><span id="address" class="formerror"
                            ...
                            <label for="form_name">Your Review <small>*</small></label>
                                        <input id="form_name" name="review" class="form-control" type="textarea"
                                            placeholder="Enter Your Review" required><span id="review" class="formerror"
                                            style="color: red"> </span></b>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group" id="img">
                                        ...
                                        <input id="img" type="file" name="img" required><span id="img" class="formerror"
                                            style="color: red"> </span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group" id="img">
                                        ...
                                        <input id="img" type="file" name="report"><span id="img" class="formerror"
                                            style="color: red"> </span>
                                    </div>
                                </div>
                            </div>
