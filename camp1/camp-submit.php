<?php
   ...
   if (isset($_POST["submit"])) {
           ...
           $insert="INSERT INTO `camp1`(`sr`,`date`, `time`, `name`, `phone`, `disease`, `message`, `address`, `category`, `other`, `source`, `remark1`) VALUES ('','$date','$time','$name','$phone','$disease','$message','$address','$category','$other','$source','$remark1')";
