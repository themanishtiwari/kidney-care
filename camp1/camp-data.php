...
$table= "SELECT * FROM  camp1 $sub_sql ORDER BY sr DESC";
$result =mysqli_query($conn,$table);
  while ($row= mysqli_fetch_array($result)) { 
    ...
    <tr>
      ...
      <td><form method="post" action="camp-edit.php"><button class="btn btn-secondary" type="submit" name="submit" value="<?php echo $row['sr'] ?>" class="btn">Edit</button></form></td>
      </tr>
...
<b>Download Patients Details in CSV👉   </b>
    <a href="camp-download.php"><button type="button" class="btn btn-success">download</button></a>
<br>
</center>
</body>
<script>
